        ...
        points={[
          {
            ...
            body: 'Account record, devices, preferences, profile and hangar snapshots, shares, and every event. One click in Settings, streamed straight from the server.',
          },
          {
            title: 'Open formats',
            body: 'NDJSON for the timeline, CSV for the event table, ZIP bundle for everything. Nothing you can’t open in a text editor.',
          },
          {
